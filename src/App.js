...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      view: 'desktop',
      theme: 'indigo',
      blockType: 'Fondations',
      blockName: 'FondationsA',
      markup: ''
    }
    ...
    return (
      <div className={`app${darkMode ? ' dark-mode' : ''}${sidebar ? ' has-sidebar' : ''} ${theme} ${view}`}>
        ...
        <div className="toolbar">
          <button className="opener" onClick={this.toggleSidebar} ref={this.openerRef}>JULO DESIGN SYSTEM</button>
          {this.state.codeView &&
